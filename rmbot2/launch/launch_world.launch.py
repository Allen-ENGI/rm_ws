...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('rmbot2')
    ...
    get_package_share_directory(pkgname), 'description', 'robot.urdf.xacro')])

    rsp = IncludeLaunchDescription(
                PythonLaunchDescriptionSource([os.path.join(
                    get_package_share_directory(pkgname),'launch','rsp.launch.py'
